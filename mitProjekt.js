...
function setup() {
  ...
  hastighed = new slider("vinkelacceleration", 0.05, 1, 0.1, 0.05, 10, 170, "");

  Flerelegemer = createCheckbox("Andet legeme");
  Flerelegemer.position(10, 320);

  knap = createButton("roter");
  knap.position(10, 265);
  knap.mousePressed(() => {
    roter = !roter;
    vinkel = 0;
    v2 = 1;
...
function draw() {
  ...
  fill("black");
  text("Inertimoment:" + Math.round(I) + "·10⁻⁴·kg·m²", 10, 230);

  //Husk at du ikke har de tigtige enheder til I

  //fiks cylinderrings problemet

  //Lav en knap, hvor man kan vælge mellem kosntant acceleration og konstant haatighed

  //en udskriv funktion noget log
